...
public class Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        resultLabel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(resultLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 349, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(5, 5, 5)
    ...
    /**
     * 0-9 numbers and point (.)
     *
     * @param evt
     */
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        String text = resultLabel.getText();
        if (evt.getActionCommand().equals(".") && text.contains(".")) {
            return;
        }
        if ((text.equals("0") && !evt.getActionCommand().contains(".")) || nextNumber) {
            text = "";
            nextNumber = false;
        }
        resultLabel.setText(text + evt.getActionCommand());
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        action = Action.getActionBySymbol(evt.getActionCommand());
        nextNumber = true;
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        if (action != null && firstNumber != null) {
            ...
            resultLabel.setText(model.getResult(action, firstNumber, secondNumber));
            reset();
            nextNumber = true;
        }
