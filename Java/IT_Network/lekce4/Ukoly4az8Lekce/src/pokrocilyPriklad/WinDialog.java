...
public class WinDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ZADEJ SVOU PŘEZDÍVKU:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        BestPlayerList.addPlayer(jTextField1.getText(), wrongTips);
        BestPlayers bestPlayers = new BestPlayers((Frame) getParent(), true);
        dispose();
