...
//== SOUKROME A POMOCNE METODY INSTANCI ========================================
    ...
    private TKabina[] vytvorTrojici( Class trida )
    {
        ...
        {
            trojice[i++] = new TKabina( vnejsi,  true );
            trojice[i++] = new TKabina( stredni, true );
            trojice[i++] = new TKabina( vnitrni, true );
            trojice[i++] = new TKabina( vnejsi,  false );
            trojice[i++] = new TKabina( stredni, false );
            trojice[i++] = new TKabina( vnitrni, false );
            P.cekej( 1000 );
        };
        return trojice;
    }
...
//== VNORENE A VNITRNI TRIDY ===================================================
    ...
    private static class TKabina
    {
         ...
         */
        TKabina( Linka linka, boolean dopredu )
        {
            if( trida == null )
