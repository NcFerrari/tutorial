...
//== KONSTANTNI ATRIBUTY TRIDY =================================================
    ...
    /* Rozdil mezi maximalni a minialni rychlosti pro generaci
     * nahodnych rychlosti. */
    private static final int MM_RYCHLOST = MAX_RYCHLOST - MIN_RYCHLOST;

    /* Velikost kroku aktivniho platna (konstatnu AP trida dedi po rodicich. */
    private static final int KROK = AP.getKrok();
    ...
    public static final int MAX_X = (AP.getSirka() - 1) * KROK;

    /* Maximlalni svisla souradnice molekuly. */
    public static final int MAX_Y = (AP.getVyska() - 1) * KROK;
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    {
        int sekund = P.zadej( "Kolik sekund maji molekuly bezet", 5 );
        start5();
