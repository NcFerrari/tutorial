...
//== PROMENNE ATRIBUTY INSTANCI ================================================
    ...
    private Class ufoClass = UFO.class;

    /** Konstruktor, kterym budou vytvarena nova UFO. */
    private Constructor ufoKonstruktor;
    {
        try
        {
...
//== NOVE ZAVEDENE METODY INSTANCI =============================================
     ...
     * Nastavi pouzivani UFO, jez budou instancemi tridy UFO.
     */
    public void pouzijUFO_3a()
    {
        pouzijTridu( UFO_3a.class );
    }
     ...
     *                  pouzity jako UFO.
     */
    public void pouzijTridu( Class ufoClass )
    {
    ...
    public UFO pristavUFO()
    {
        ...
        try
        {
            //ovladane = new UFO_3a( talir, ++pocetUFO );
...
//== VNORENE A VNITRNI TRIDY ===================================================
    ...
    {
        double xPos;    //Bodova x-ova souradnice pocatku
        double yPos;    //Bodova y-ova souradnice pocatku
    ...
    }//private static abstract class Tvar
