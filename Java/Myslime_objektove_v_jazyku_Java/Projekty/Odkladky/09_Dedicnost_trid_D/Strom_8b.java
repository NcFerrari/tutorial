/*******************************************************************************
 * Trida Strom_8b obsahuje podobu tridy po definici rodicovske tridy Hybaci. 
 *
 *  Od Strom_8a je zmeneno:
 ...
 */
public class Strom_8b extends Hybaci implements IHybaci
{
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        AP.nekresli();        
            ...
            new Strom_8b( 0, 0, sirka, vyska ).nakresli();
        AP.vratKresli();
    }
    ...
    public static void alej()
    {
        AP.nekresli();        
            ...
            new Strom_8b( 100,   0 ).nakresli();
            new Strom_8b( 300,   0 ).nakresli();
            new Strom_8b(  50, 100 ).nakresli();
            new Strom_8b( 250, 100 ).nakresli();
            new Strom_8b(   0, 200 ).nakresli();
            new Strom_8b( 200, 200 ).nakresli();
        AP.vratKresli();
    }
...
//== KONSTRUKTORY A METODY VRACEJICI INSTANCE VLASTNI TRIDY ====================
     ...
     */
    public Strom_8b(int x, int y, int sirka, int vyska)
    {
     ...
     */
    public Strom_8b(Pozice pozice, Rozmer rozmer)
    {
     ...
     */
    public Strom_8b(int x, int y, int sirka, int vyska, int podilSirkyKmene, int podilVyskyKmene)
    {
