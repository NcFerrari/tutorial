/*******************************************************************************
 * Instance tridy Kabina_8b predstavuji kabiny pohybujici se po linkach.
 *
 * Oproti tride Kabina_8b:
 ...
 */
public class Kabina_8c implements IMultiposuvny
{
...
//== KONSTRUKTORY A METODY VRACEJICI INSTANCE VLASTNI TRIDY ====================
     ...
     */
    protected Kabina_8c(Linka linka)
    {
        this.linka = linka;
    ...
    public static Kabina_8c getInstance( Linka linka )
    {
        Kabina_8c kabina = new Kabina_8c( linka );
        kabina.presunuto();
        return kabina;
    }
