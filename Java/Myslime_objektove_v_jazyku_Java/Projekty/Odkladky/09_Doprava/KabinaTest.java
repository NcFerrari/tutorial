...
//== VLASTNI TESTY =============================================================
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testKabina_8b()
    {
        TKabina[] k3 = vytvorTrojici( Kabina_8b.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testKabina_8c()
    {
        TKabina[] k3 = vytvorTrojici( Kabina_8c.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_8a()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_8a.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_8b()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_8b.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_8c()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_8c.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_8d()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_8d.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
    ...
    {
        TKabina[] tam3 = vytvorTrojici( Kabina_8c.class );
        TKabina[] zpet3 = vytvorTrojici( ZpetnaKabina_8d.class );
        zrychliLinky();
        ukonciSkupinu( tam3 );
        ukonciSkupinu( zpet3 );
    }
