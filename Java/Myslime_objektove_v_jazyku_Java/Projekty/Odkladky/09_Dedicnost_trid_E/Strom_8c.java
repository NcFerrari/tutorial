/*******************************************************************************
 * Trida Strom_8c obsahuje podobu tridy po definici rodicovske tridy AHybaci
 *
 *  Od Strom_8b je zmeneno:
 *  - Zmenena rodicovska trida na AHybaci
 *
 * @author     Rudolf Pecinovsky
 * @version    2.01, duben 2004
 */
public class Strom_8c extends AHybaci 
{
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        AP.nekresli();        
            ...
            new Strom_8c( 0, 0, sirka, vyska ).nakresli();
        AP.vratKresli();
    }
    ...
    public static void alej()
    {
        AP.nekresli();        
            ...
            new Strom_8c( 100,   0 ).nakresli();
            new Strom_8c( 300,   0 ).nakresli();
            new Strom_8c(  50, 100 ).nakresli();
            new Strom_8c( 250, 100 ).nakresli();
            new Strom_8c(   0, 200 ).nakresli();
            new Strom_8c( 200, 200 ).nakresli();
        AP.vratKresli();
    }
...
//== KONSTRUKTORY A METODY VRACEJICI INSTANCE VLASTNI TRIDY ====================
     ...
     */
    public Strom_8c(int x, int y, int sirka, int vyska)
    {
     ...
     */
    public Strom_8c(Pozice pozice, Rozmer rozmer)
    {
     ...
     */
    public Strom_8c(int x, int y, int sirka, int vyska, int podilSirkyKmene, int podilVyskyKmene)
    {
...
//== SOUKROME A POMOCNE METODY INSTANCI ========================================
     ...
     * @param vyska    Nove nastavovana vyska; vyska>0
     */
    private void mujSetRozmer(int sirka, int vyska)
    {
        int x = getX();
        int y = getY();
