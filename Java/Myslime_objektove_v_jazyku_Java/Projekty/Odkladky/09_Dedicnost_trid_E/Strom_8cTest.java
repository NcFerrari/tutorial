 ...
 */
public class Strom_8cTest extends junit.framework.TestCase
{
    private AktivniPlatno ap;
    private Strom_8c strom1;
    private Strom_8c strom2;
    private Strom_8c strom3;
    private Strom_8c strom4;

//+main
//== METODY TRIDY PRO PRIPRAVU A SPUSTENI SADY =================================

    /***************************************************************************
     * Definuje sadu testu, ktere ma trida Sbl_JUnitTest na starosti. 
     ...
     * <ul><code>suite.addTest( Trida.suite() )</code><br>
     *     Prida mezi testy sadu definovanou metodou <code>Trida.suite</code>.
     *     </ul>     
     * <ul><code>suite.addTest(new Trida("testXXX"))</code><br>
     *     Prida mezi testy metodu <code>testXXX</code> tridy <code>Trida</code>.
     * </ul></li>
     */
    public static junit.framework.Test suite()
    {
        ...
        //Maji-li byt do sady pridany vsechny testy teto tridy
        suite.addTestSuite( Strom_8cTest.class );
        
        //Maji-li byt pridany vsechny testy zadane tridy
        //suite.addTestSuite( Trida.class );
        
        //Jsou-li pridavane testy definovany v sade zadane tridy
        //suite.addTest( Trida.suite() );
        
        //Ma-li byt do sady pridan jeden konkretni test konkretni tridy
        //suite.addTest( new Trida("testXXX") );
...
//== KONSTRUKTORY A METODY VRACEJICI INSTANCE VLASTNI TRIDY ====================
     ...
     */
    public Strom_8cTest(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.setMrizka(true);
        ap.odstranVse();
        strom1 = new Strom_8c(   0,   0, 100, 150, 10, 3 );
        strom2 = new Strom_8c(   0, 150, 100, 150,  5, 4 );
        strom3 = new Strom_8c( 100, 100, 200, 200, 20, 2 );
        strom4 = new Strom_8c( 100,   0, 150, 100,  3, 5 );
        strom1.nakresli();
        strom2.nakresli();
        strom3.nakresli();
        strom4.nakresli();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_8c.obrazek( new Oblast (100, 100, 100, 100), 10 );
