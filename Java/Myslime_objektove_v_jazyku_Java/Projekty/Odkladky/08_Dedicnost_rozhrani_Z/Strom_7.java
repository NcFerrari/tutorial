/*******************************************************************************
 * Trida Strom_7 obsahuje podobu tridy po implementaci rozhrani IHybaci.
 *
 ...
 */
public class Strom_7 implements IHybaci 
{
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        AP.nekresli();        
            ...
            new Strom_7( 0, 0, sirka, vyska ).nakresli();
        AP.vratKresli();
    }
    ...
    public static void alej()
    {
        AP.nekresli();        
            ...
            new Strom_7( 100,   0 ).nakresli();
            new Strom_7( 300,   0 ).nakresli();
            new Strom_7(  50, 100 ).nakresli();
            new Strom_7( 250, 100 ).nakresli();
            new Strom_7(   0, 200 ).nakresli();
            new Strom_7( 200, 200 ).nakresli();
        AP.vratKresli();
    }
...
//== KONSTRUKTORY A METODY VRACEJICI INSTANCE VLASTNI TRIDY ====================
     ...
     */
    public Strom_7(int x, int y, int sirka, int vyska)
    {
     ...
     */
    public Strom_7(Pozice pozice, Rozmer rozmer)
    {
