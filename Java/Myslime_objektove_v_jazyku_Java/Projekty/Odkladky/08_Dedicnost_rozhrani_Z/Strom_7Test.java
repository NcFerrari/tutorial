 ...
 */
public class Strom_7Test extends junit.framework.TestCase
{
    private AktivniPlatno ap;
    private Strom_7 strom1;
    private Strom_7 strom2;
    private Strom_7 strom3;
    private Strom_7 strom4;
...
//== KONSTRUKTORY A METODY VRACEJICI INSTANCE VLASTNI TRIDY ====================
     ...
     */
    public Strom_7Test(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.setMrizka(true);
        ap.odstranVse();
        strom1 = new Strom_7(   0,   0, 100, 150, 10, 3 );
        strom2 = new Strom_7(   0, 150, 100, 150,  5, 4 );
        strom3 = new Strom_7( 100, 100, 200, 200, 20, 2 );
        strom4 = new Strom_7( 100,   0, 150, 100,  3, 5 );
        strom1.nakresli();
        strom2.nakresli();
        strom3.nakresli();
        strom4.nakresli();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_7.obrazek( new Oblast (100, 100, 100, 100), 10 );
