...
/*******************************************************************************
 * Trida Strom_8 obsahuje podobu tridy po implementaci rozhrani IHybaci.
 *
 *  Od Strom_6c je zmeneno:
 *  - Mista nekolika rozhrani nyni implementuje pouze IHybaci
 *
 * @author     Rudolf Pecinovsky
 * @version    2.01, duben 2004
 */
public class Strom_8 implements IHybaci 
{
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        AP.nekresli();        
            ...
            new Strom_8( 0, 0, sirka, vyska ).nakresli();
        AP.vratKresli();
    }
    ...
    public static void alej()
    {
        AP.nekresli();        
            ...
            new Strom_8( 100,   0 ).nakresli();
            new Strom_8( 300,   0 ).nakresli();
            new Strom_8(  50, 100 ).nakresli();
            new Strom_8( 250, 100 ).nakresli();
            new Strom_8(   0, 200 ).nakresli();
            new Strom_8( 200, 200 ).nakresli();
        AP.vratKresli();
    }
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_8(int x, int y, int sirka, int vyska)
    {
     ...
     */
    public Strom_8(Pozice pozice, Rozmer rozmer)
    {
     ...
     */
    public Strom_8(int x, int y, int sirka, int vyska, int podilSirkyKmene, int podilVyskyKmene)
    {
