 ...
 */
public class Strom_8Test extends junit.framework.TestCase
{
    private AktivniPlatno ap;
    private Strom_8 strom1;
    private Strom_8 strom2;
    private Strom_8 strom3;
    private Strom_8 strom4;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_8Test(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.odstranVse();
        strom1 = new Strom_8();                        
        strom2 = new Strom_8( 25, 150);                
        strom3 = new Strom_8(100, 100, 100,  90);      
        strom4 = new Strom_8(200,   0, 100, 300, 5, 5);
        strom1.nakresli();
        strom2.nakresli();
        strom3.nakresli();
        strom4.nakresli();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_8.obrazek( new Oblast (100, 100, 100, 100), 10 );
