/*******************************************************************************
 * Testovaci trida Zlomek_4Test slouzi ke komplexnimu otestovani vzoroveho
 * reseni definice tridy zlomku spolu s operacemi zlomkove aritmetiky.
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public class Zlomek_4Test extends junit.framework.TestCase
{
    Zlomek_4 z0, z1, z2, z12, z34, z56;
    Zlomek_4 v1, v2, v3;
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        z1 = new Zlomek_4( 1 );
        z2 = new Zlomek_4( 2 );
        z12 = new Zlomek_4( 1, 2 );
        z34 = new Zlomek_4( 3, 4 );
        z56 = new Zlomek_4( 5, 6 );
    }
...
//== SOUKROME A POMOCNE METODY TRIDY ===========================================
     ...
     */
    public static void tiskni( Zlomek_4 v, Zlomek_4 z1, char op, Zlomek_4 z2 )
    {
     ...
     */
    public static void tiskni( String cislo, Zlomek_4 z )
    {
...
//== VLASTNI TESTY =============================================================
    ...
    {
        z1 = new Zlomek_4( 2 );
        System.out.println("Zlomek_4(2) = " + z1);
        assertEquals( "[2/1]", z1.toString() );

        z1 = new Zlomek_4( 1, 2 );
        System.out.println("Zlomek_4(1, 2) = " + z1);
        assertEquals( "[1/2]", z1.toString() );

        z1 = new Zlomek_4( 2, 4 );
        System.out.println("Zlomek_4(2, 4) = " + z1);
        assertEquals( "[1/2]", z1.toString() );

        z2 = new Zlomek_4( z1 );
        System.out.println("Zlomek_4(" + z1 + ") = " + z2);
    ...
    public void testPrevody()
    {
        int i;
        double d;
        Zlomek_4 z125 = new Zlomek_4( 12, 5 );
