/*******************************************************************************
 * Testovaci trida ZlomekTest slouzi ke komplexnimu otestovani
 * reseni definice tridy zlomku spolu s operacemi zlomkove aritmetiky.
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public class ZlomekTest extends junit.framework.TestCase
{
    Zlomek z0, z1, z2, z12, z34, z56;
    Zlomek v1, v2, v3;
...
//== SOUKROME A POMOCNE METODY TRIDY ===========================================
     ...
     */
    public static void tiskni( Zlomek v, Zlomek z1, char op, Zlomek z2 )
    {
     ...
     */
    public static void tiskni( String cislo, Zlomek z )
    {
...
//== VLASTNI TESTY =============================================================
    ...
    {
        z1 = new Zlomek( 2 );
        System.out.println("Zlomek(2) = " + z1);
        assertEquals( "[2/1]", z1.toString() );

        z1 = new Zlomek( 1, 2 );
        System.out.println("Zlomek(1, 2) = " + z1);
        assertEquals( "[1/2]", z1.toString() );

        z1 = new Zlomek( 2, 4 );
        System.out.println("Zlomek(2, 4) = " + z1);
        assertEquals( "[1/2]", z1.toString() );

        z2 = new Zlomek( z1 );
        System.out.println("Zlomek(" + z1 + ") = " + z2);
