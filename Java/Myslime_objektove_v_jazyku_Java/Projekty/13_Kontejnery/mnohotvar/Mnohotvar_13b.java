 ...
 *
 * Oproti tride Mnohotvar_13a se zmenilo:
 * - Pri zmene rozmeru se cisla typu double nepretypovavaji na int,
 *   ale misto toho se zaokrouhluji.
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public class Mnohotvar_13b extends AHybaci
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Mnohotvar_13b(String nazev)
    {
        super( 0, 0, 0, 0 );
        if( nazev != "" )
            this.nazev = nazev;
