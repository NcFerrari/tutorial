...
/*******************************************************************************
 * Trida Molekula_13e definuje sadu metod, ktere vygeneruji na platno
...
//== KONSTANTNI ATRIBUTY TRIDY =================================================
    ...
    private static final Set<Molekula_13e> molekuly =
                                           new LinkedHashSet<Molekula_13e>();
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static boolean dalsi( int pokusu )
    {
        ...
        Molekula_13e m = new Molekula_13e( x, y );
        return true;
    }
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Molekula_13e(int x, int y)
    {
        super( x, y, PRUMER );
        this.x = x;
        this.y = y;
...
//== VNORENE A VNITRNI TRIDY ===================================================
    ...
    /*******************************************************************************
     * Trida AnimatorMolekul_13e definuje skupinu objekt, ktery zabezpeci
    ...
    //== KONSTANTNI ATRIBUTY TRIDY =================================================
        ...
        private static final int V_POZICE = (int)(Molekula_13e.PRUMER * POMER);

        /** Rozmer vylevky a generatoru molekul. */
        private static final int V_ROZMER = (int)(Molekula_13e.PRUMER * (1+POMER));

        /** Souradnice generatoru molekul. */
        private static final int X_GENERATORU = Molekula_13e.maxX - V_POZICE;
        private static final int Y_GENERATORU = Molekula_13e.maxY - V_POZICE;

        /** Maximalni souradnice molekuly nazasahujici do generatoru. */
        private static final int XX = X_GENERATORU - Molekula_13e.PRUMER;
        private static final int YY = Y_GENERATORU - Molekula_13e.PRUMER;

        /** AP od tridy Molekula_13e je nedosazitelne, protoze ta je dedi od
    ...
    //== KONSTRUKTORY A TOVARNI METODY =============================================
        ...
        public AnimatorMolekul()
        {
            ...
            new Timer().schedule( this, 0, 1000 / Molekula_13e.FREKVENCE );
        }
    ...
    //== PREKRYTE ABSTRAKTNI METODY RODICOVSKE TRIDY ===============================
        ...
        {
            AP.nekresli();
                for( Iterator<Molekula_13e>it = Molekula_13e.molekuly.iterator();
                     it.hasNext();  )
                {
                    Molekula_13e m = it.next();
    ...
    //== SOUKROME A POMOCNE METODY INSTANCI ========================================
        ...
        private void zkusNovou()
        {
            ...
            for( Molekula_13e m : Molekula_13e.molekuly )
            {
                if( (m.x > XX)  &&  (m.y > YY) )
                {
                    prekazi = true;
            ...
            if( !prekazi )
            {
                new Molekula_13e( (X_GENERATORU + V_POZICE/2),
