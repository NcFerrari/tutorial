...
public class Strom_3b 
{
    ...
    public Strom_3b( int x, int y )
    {
        this( x, y, 100, 150 );
    }

    public Strom_3b( int x, int y, int sirka, int vyska )
    {
...
//
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        ...
        new Strom_3b( 0, 0, sirka, vyska );
    }

    public static void alej()
    {
        Platno.getPlatno().setRozmer( 400, 350 );
        new Strom_3b( 100,   0 );      new Strom_3b( 300,   0 );
        new Strom_3b(  50, 100 );      new Strom_3b( 250, 100 );
        new Strom_3b(   0, 200 );      new Strom_3b( 200, 200 );
    }
} 
