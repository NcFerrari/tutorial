/*******************************************************************************
 * Trida Strom_4 rozsiruje definici o konstrukce probrane ve ctvrte kapitole
 * do podkapitoly a refaktoraci.
 *
 *  Od Strom_3c je tu pridano:
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void alej()
    {
        ...
        new Strom_4( 100,   0 );      new Strom_4( 300,   0 );
        new Strom_4(  50, 100 );      new Strom_4( 250, 100 );
        new Strom_4(   0, 200 );      new Strom_4( 200, 200 );
    }
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
    ...
    /***************************************************************************
     * Implicitni konstruktor tridy Strom_4 vytvori v levem hornim rohu platna
     ...
     */
    public Strom_4( int x, int y, int sirka, int vyska )
    {
