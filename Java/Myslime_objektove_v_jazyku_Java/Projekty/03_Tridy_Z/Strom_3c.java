/*******************************************************************************
 * Trida Strom_3c obsahuje podobu tridy po zavedeni komentaru.
 *
 * Oproti verzi Strom_3b je zdrojovy kod pouze okomentovan
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    {
        Platno.getPlatno().setRozmer( 400, 350 );
        new Strom_3c( 100,   0 );      new Strom_3c( 300,   0 );
        new Strom_3c(  50, 100 );      new Strom_3c( 250, 100 );
        new Strom_3c(   0, 200 );      new Strom_3c( 200, 200 );
    }
...
//== KONSTRUKTORY ==============================================================
    ...
    /***************************************************************************
     * Implicitni konstruktor tridy Strom_3c vytvori v levem hornim rohu platna
     ...
     */
    public Strom_3c( int x, int y, int sirka, int vyska )
    {
