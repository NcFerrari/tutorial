...
/*******************************************************************************
 * Instance tridy Linka predstavuji linku, po ktere se budou pohybovat
...
//== OSTATNI METODY TRIDY ======================================================
     ...
     * zadanou rychlosti; ocekava, ze platno ma rozmery alespon 7\u00d77 poli.
     */
    public static Linka vytvorVnejsi( int rychlost )
    {
        int sirka = Math.max( AP.getSirka() * AP.getKrok(), 350 );
        int vyska = Math.max( AP.getVyska() * AP.getKrok(), 350 );
     ...
     * zadanou rychlosti; ocekava, ze platno ma rozmery 6\u00d76 poli.
     */
    public static Linka vytvorStredni( int rychlost )
    {
        int sirka = Math.max( AP.getSirka() * AP.getKrok(), 300 );
        int vyska = Math.max( AP.getVyska() * AP.getKrok(), 300 );
        AP.setKrokRozmer( 1, sirka, vyska );
     ...
     * zadanou rychlosti; ocekava, ze platno ma rozmery 7\u00d77 poli.
     */
    public static Linka vytvorVnitrni( int rychlost )
    {
        int sirka = Math.max( AP.getSirka() * AP.getKrok(), 250 );
        int vyska = Math.max( AP.getVyska() * AP.getKrok(), 250 );
        AP.setKrokRozmer( 1, sirka, vyska );
...
//== PRISTUPOVE METODY ATRIBUTU INSTANCI =======================================
    ...
    /***************************************************************************
     * Vrati doporucenou dobu cekani kabin ve stanici nez vyjednou dal;
...
//== PREKRYTE KONKRETNI METODY RODICOVSKE TRIDY ================================
    ...
    {
        return P.nazevTridy( this ) + "_" + barva;
    }
...
//== VNORENE A VNITRNI TRIDY ===================================================
    ...
    //== PREKRYTE KONKRETNI METODY RODICOVSKE TRIDY ============================
        ...
        public String toString()
        {
            return P.nazevTridy( this ) + "_" + barva + "_" + zporadi + 
    ...
    //== SOUKROME A POMOCNE METODY INSTANCI ====================================
        ...
        private void naLince() 
        {
            if( funkcni )   return;
            throw new IllegalStateException(
                "Zastavka je jiz zrusena a nelze ji tedy pouzivat" );
        }
    ...
    //== VNORENE A VNITRNI TRIDY ===============================================
    //== TESTY A METODA MAIN ===================================================
    }//public class Zastavka extends kniha.tvary.APosuvny
