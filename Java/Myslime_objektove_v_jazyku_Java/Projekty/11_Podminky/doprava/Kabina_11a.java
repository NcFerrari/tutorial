...
/*******************************************************************************
 * Instance tridy Kabina_11a predstavuji kabiny pohybujici se po linkach.
 *
 * Oproti tride Kabina_9c:
 * - pribyly prikazy import umoznujici vyuzivat tridy z knihovny
 *
 * @author  Rudolf Pecinovsky
 * @version 1.00,  29.02.2004
 */
public class Kabina_11a implements IMultiposuvny
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    protected Kabina_11a(Linka linka)
    {
        this.linka = linka;
     ...
     * @param linka    Linka, po ktere se kabina pohybuje.
     */
    public static Kabina_11a getInstance( Linka linka )
    {
        Kabina_11a kabina = new Kabina_11a( linka );
        kabina.presunuto();
        return kabina;
    }
