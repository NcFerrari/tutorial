...
//== KONSTRUKTORY A TOVARNI METODY =============================================
                     ...
                     int delkaLetadla, int rychlostLetadla)
    {
        ...
        AP.setKrokRozmer( 1,  sirkaNebe,  vyskaNebe );
        AP.setBarvaPozadi( Barva.AZUROVA );

        //Strilet budeme z poloviny platna
        xStrely = (AP.getSirka() - Strela.PRUMER) / 2;
        ...
        hlaven  = new Obdelnik(
                     xStrely - 1,                       //x
                     AP.getVyska() - vyskaHlavne,       //y
                     Strela.PRUMER + 2,                 //sirka
                     vyskaHlavne,                       //vyska
                     Barva.CERNA );                     //barva
        AP.pridej( hlaven );

        letadlo = new Letadlo( delkaLetadla, rychlostLetadla, MP );
