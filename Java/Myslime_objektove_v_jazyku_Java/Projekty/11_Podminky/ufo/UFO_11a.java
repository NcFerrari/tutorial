...
/*******************************************************************************
 * Trida UFO_11a obsahuje vzorove reseni pro tridu UFO, ktera
 ...
 */
public class UFO_11a extends UFO
{
...
//== KONSTANTNI ATRIBUTY INSTANCI ==============================================
    ...
    protected Talir talir;
    protected Cislo cislo;
    protected int   poradi;


//== PROMENNE ATRIBUTY INSTANCI ================================================

    protected double xTah,      yTah;
    protected double xRychlost, yRychlost;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public UFO_11a(Talir talir, int poradi)
    {
        super( talir, poradi );
        xPos = talir.getX();
        yPos = talir.getY();
...
//== TESTY A METODA MAIN =======================================================
    ...
    {
        Dispecer.getDispecer().pouzijTridu( UFO_11a.class );
    }
