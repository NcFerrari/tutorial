...
/*******************************************************************************
 * Trida RotUFO_11d obsahuje vzorove reseni pro tridu UFO, ktera
 ...
 */
public class RotUFO_11d extends RotUFO_11b
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public RotUFO_11d(Talir talir, int poradi)
    {
        super( talir, poradi );
    }
...
//== TESTY A METODA MAIN =======================================================
    ...
    {
        Dispecer.getDispecer().pouzijTridu( RotUFO_11d.class );
    }
