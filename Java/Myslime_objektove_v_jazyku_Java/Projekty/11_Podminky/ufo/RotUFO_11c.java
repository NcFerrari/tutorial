...
/*******************************************************************************
 * Trida RotUFO_11c obsahuje vzorove reseni pro tridu UFO, ktera
 ...
 */
public class RotUFO_11c extends RotUFO_11b
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public RotUFO_11c(Talir talir, int poradi)
    {
        super( talir, poradi );
    }
...
//== NOVE ZAVEDENE METODY INSTANCI =============================================
    ...
    public void popojed( int frekvence )
    {
        ...
        if( Math.abs(xRychlost) > VSIRKA/3 )
            throw new IllegalStateException("\nPrilis velka vodorovna rychlost");

        if( Math.abs(yRychlost) > VVYSKA/3 )
            throw new IllegalStateException("\nPrilis velka svisla rychlost");
    }
...
//== TESTY A METODA MAIN =======================================================
    ...
    {
        System.out.println();
        Dispecer.getDispecer().pouzijTridu( RotUFO_11c.class );
    }
