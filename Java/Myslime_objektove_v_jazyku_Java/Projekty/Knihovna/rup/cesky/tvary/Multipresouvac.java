 ...
 * Obdobne jako AktivniPlatno prijima prostrednictvim metody <code>pridej</code>
...
//== KONSTRUKTORY A METODY VRACEJICI INSTANCE VLASTNI TRIDY ====================
    ...
    /***************************************************************************
     * Vytvori novy multipresouvac s implicitni periodou (50 ms).
     */
...
//== PRISTUPOVE METODY ATRIBUTU INSTANCI =======================================
    ...
    public IPosuvny[] getPresouvane()
    {
        ...
        {
            return (IPosuvny[])(presouvane.keySet().toArray(new IPosuvny[0]));
        }
    }
...
//== VNORENE A VNITRNI TRIDY ===================================================
    ...
    private class Animace
    {
        ...
        Animace( IPosuvny ip, int xn, int yn, int rychlost, double doba )
        {
            ...
            if( rychlost > 0 )
            {
            	double vzdalenost = P.prepona( dx, dy );
            ...
            synchronized( presouvane )
            {
                ...
                while( it.hasNext() )
                {
                    ...
                    if( --a.kroku == 0 )
                    {
                        ...
                        {
                            final IMultiposuvny aa = (IMultiposuvny) (a.objekt);
                            Thread t = new Thread(a.toString()) {
                                public void run() {
                                    aa.presunuto( Multipresouvac.this );
                                }//public void run()
                            };//Thread t = new Thread()
                            t.start();
                        }
...
//== TESTY A METODA MAIN =======================================================
}//public class Multipresouvac extends TimerTask
