...
//== KONSTRUKTORY A TOVARNI METODY =============================================
    ...
    {
        this.talir = talir;
        cislo = new Cislo(poradi, talir.getX() , talir.getY());
        x = talir.getX();
        y = talir.getY();
    }
...
//== NOVE ZAVEDENE METODY INSTANCI =============================================
    ...
    {
        rychlostX = getXRychlost() + (getXTah() / frekvence);
        rychlostY = getYRychlost() + (getYTah() / frekvence);
        x = getX() + (getXRychlost() / frekvence);
        y = getY() + (getYRychlost() / frekvence);
        talir.setPozice( x, y );
        cislo.setPozice( x, y );
    }
