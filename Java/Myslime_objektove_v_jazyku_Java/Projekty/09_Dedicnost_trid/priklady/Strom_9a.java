...
/*******************************************************************************
 * Trida Strom_9a obsahuje podobu tridy po definici rodicovske tridy Posuvny.
 *
 ...
 */
public class Strom_9a extends Posuvny implements IHybaci 
{
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        AP.nekresli();        
            ...
            new Strom_9a( 0, 0, sirka, vyska ).nakresli();
        AP.vratKresli();
    }
    ...
    public static void alej()
    {
        AP.nekresli();        
            ...
            new Strom_9a( 100,   0 ).nakresli();
            new Strom_9a( 300,   0 ).nakresli();
            new Strom_9a(  50, 100 ).nakresli();
            new Strom_9a( 250, 100 ).nakresli();
            new Strom_9a(   0, 200 ).nakresli();
            new Strom_9a( 200, 200 ).nakresli();
        AP.vratKresli();
    }
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_9a(int x, int y, int sirka, int vyska)
    {
     ...
     */
    public Strom_9a(Pozice pozice, Rozmer rozmer)
    {
     ...
     */
    public Strom_9a(int x, int y, int sirka, int vyska, int podilSirkyKmene, int podilVyskyKmene)
    {
        super( x, y );
