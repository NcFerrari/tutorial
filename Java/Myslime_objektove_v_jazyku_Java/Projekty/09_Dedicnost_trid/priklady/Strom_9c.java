...
/*******************************************************************************
 * Trida Strom_9c obsahuje podobu tridy po definici rodicovske tridy AHybaci
 *
 *  Od Strom_9b je zmeneno:
 *  - Zmenena rodicovska trida na AHybaci
 *
 * @author     Rudolf Pecinovsky
 * @version    2.01, duben 2004
 */
public class Strom_9c extends AHybaci 
{
...
//== OSTATNI METODY TRIDY ======================================================
    ...
    public static void zaramuj( int sirka, int vyska )
    {
        AP.nekresli();        
            ...
            new Strom_9c( 0, 0, sirka, vyska ).nakresli();
        AP.vratKresli();
    }
    ...
    public static void alej()
    {
        AP.nekresli();        
            ...
            new Strom_9c( 100,   0 ).nakresli();
            new Strom_9c( 300,   0 ).nakresli();
            new Strom_9c(  50, 100 ).nakresli();
            new Strom_9c( 250, 100 ).nakresli();
            new Strom_9c(   0, 200 ).nakresli();
            new Strom_9c( 200, 200 ).nakresli();
        AP.vratKresli();
    }
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_9c(int x, int y, int sirka, int vyska)
    {
     ...
     */
    public Strom_9c(Pozice pozice, Rozmer rozmer)
    {
     ...
     */
    public Strom_9c(int x, int y, int sirka, int vyska, int podilSirkyKmene, int podilVyskyKmene)
    {
