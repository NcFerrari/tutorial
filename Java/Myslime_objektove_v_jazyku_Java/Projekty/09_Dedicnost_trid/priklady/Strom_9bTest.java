 ...
 */
public class Strom_9bTest extends junit.framework.TestCase
{
    private AktivniPlatno ap;
    private Strom_9b strom1;
    private Strom_9b strom2;
    private Strom_9b strom3;
    private Strom_9b strom4;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_9bTest(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.odstranVse();
        strom1 = new Strom_9b();                        
        strom2 = new Strom_9b( 25, 150);                
        strom3 = new Strom_9b(100, 100, 100,  90);      
        strom4 = new Strom_9b(200,   0, 100, 300, 5, 5);
        strom1.nakresli();
        strom2.nakresli();
        strom3.nakresli();
        strom4.nakresli();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_9b.obrazek( new Oblast (100, 100, 100, 100), 10 );
