...
/*******************************************************************************
 * Testovaci trida XObdelnik_9Test slouzi ke komplexnimu otestovani tridy
 * XObdelnik_9.
 *
 * @author    Rudolf Pecinovsky
 * @version   1.00,  05.2004
 */
public class XObdelnik_9Test extends junit.framework.TestCase
{
    private AktivniPlatno AP;
    private int krok;
    private XObdelnik_9 xo1;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public XObdelnik_9Test(String nazev)
    {
        super( nazev );
    }
