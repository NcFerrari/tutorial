 ...
 */
public class Terc_9 extends Kruh
{
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Terc_9(int x, int y, int prumer)
    {
     ...
     */
    public Terc_9(Pozice pocatek, int prumer)
    {
     ...
     */
    public Terc_9(Pozice pocatek, int prumer, Barva barva1, Barva barva2, Barva barva3)
    {
     ...
     * @param barva3   Barva centralniho kruhu
     */
    public Terc_9(Oblast oblast, Barva barva1, Barva barva2, Barva barva3)
    {
        this( oblast.x, oblast.y, Math.min(oblast.sirka, oblast.vyska),
     ...
     * @param barva3  Barva centralniho kruhu
     */
    public Terc_9(int x, int y, int prumer, Barva barva1, Barva barva2, Barva barva3)
    {
