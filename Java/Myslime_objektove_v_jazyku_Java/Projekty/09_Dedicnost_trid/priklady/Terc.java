...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Terc(Pozice pocatek, int prumer)
    {
     ...
     */
    public Terc(Pozice pocatek, int prumer, Barva barva1, Barva barva2, Barva barva3)
    {
     ...
     * @param barva3   Barva centralniho kruhu
     */
    public Terc(Oblast oblast, Barva barva1, Barva barva2, Barva barva3)
    {
        this( oblast.x, oblast.y, Math.min(oblast.sirka, oblast.vyska),
     ...
     * @param barva3  Barva centralniho kruhu
     */
    public Terc(int x, int y, int prumer, Barva barva1, Barva barva2, Barva barva3)
    {
