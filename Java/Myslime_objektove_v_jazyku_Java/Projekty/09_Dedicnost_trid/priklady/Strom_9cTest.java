 ...
 */
public class Strom_9cTest extends junit.framework.TestCase
{
    private AktivniPlatno ap;
    private Strom_9c strom1;
    private Strom_9c strom2;
    private Strom_9c strom3;
    private Strom_9c strom4;
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Strom_9cTest(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        ap.odstranVse();
        strom1 = new Strom_9c();                        
        strom2 = new Strom_9c( 25, 150);                
        strom3 = new Strom_9c(100, 100, 100,  90);      
        strom4 = new Strom_9c(200,   0, 100, 300, 5, 5);
        strom1.nakresli();
        strom2.nakresli();
        strom3.nakresli();
        strom4.nakresli();
...
//== VLASTNI TESTY =============================================================
    ...
    {
        Strom_9c.obrazek( new Oblast (100, 100, 100, 100), 10 );
