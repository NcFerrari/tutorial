...
//== VLASTNI TESTY =============================================================
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testKabina_9b()
    {
        TKabina[] k3 = vytvorTrojici( Kabina_9b.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testKabina_9c()
    {
        TKabina[] k3 = vytvorTrojici( Kabina_9c.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_9a()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_9a.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_9b()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_9b.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_9c()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_9c.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina_9d()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina_9d.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testObaSmery_8c_8d()
    {
        TKabina[] tam3 = vytvorTrojici( Kabina_9c.class );
        TKabina[] zpet3 = vytvorTrojici( ZpetnaKabina_9d.class );
        zrychliLinky();
        ukonciSkupinu( tam3 );
        ukonciSkupinu( zpet3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testZpetnaKabina()
    {
        TKabina[] k3 = vytvorTrojici( ZpetnaKabina.class );
        zrychliLinky();
        ukonciSkupinu( k3 );
    }
     ...
     * a po potvrzeni od uzivatele pohyb kabin zrychli.
     */
    public void testObaSmery()
    {
        TKabina[] tam3 = vytvorTrojici( Kabina.class );
        TKabina[] zpet3 = vytvorTrojici( ZpetnaKabina.class );
        zrychliLinky();
        ukonciSkupinu( tam3 );
        ukonciSkupinu( zpet3 );
    }
