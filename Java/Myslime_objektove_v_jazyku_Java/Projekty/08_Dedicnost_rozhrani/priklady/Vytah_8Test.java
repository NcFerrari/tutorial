 ...
 */
public class Vytah_8Test extends junit.framework.TestCase
{
    ...
    private Vytah_8 v1;        //Vytah v prvnim sloupci
    private Vytah_8 v3;        //Vytah ve tretim sloupci
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Vytah_8Test(String nazev)
    {
        super( nazev );
    }
...
//== PRIPRAVA A UKLID PRIPRAVKU ================================================
    ...
    protected void setUp()
    {
        ...
        v1 = new Vytah_8( 1 );
        v3 = new Vytah_8( 3, 4, Barva.MODRA );
    }
