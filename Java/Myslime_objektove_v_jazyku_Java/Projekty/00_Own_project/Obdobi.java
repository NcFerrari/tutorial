...
/*******************************************************************************
 * Instance v˝ËtovÈho typu {@code Obdobi} p¯edstavujÌ ...
 *
 * @author    jmÈno autora
 * @version   0.00.000
 */
public enum Obdobi
{
    ...
    ////=====  N¡POVÃDA: KONSTRUKTOR BEZ PARAMETRŸ  ==============
    JARO ("puËÌ"),
    LETO ("zraje"),
    PODZIM ("plodÌ"),
    ZIMA ("spÌ");
    //
    ////=====  N¡POVÃDA: KONSTRUKTOR S PARAMETRY  ================
    ...
    public String zprava() {
        return "Je " + name().toLowerCase() + ", p¯Ìroda " + cinnost + ".";
    }
