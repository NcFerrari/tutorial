...
//== KONSTANTNI ATRIBUTY TRIDY =================================================
    ...
    private static final double GRAVITACNI_ZRYCHLENI  = 100;
    ...
    /** Zmena rychlosti za jeden snimek. */
    private static final double UTLUM = 1; //0.85;
...
//== TESTY A METODA MAIN =======================================================
    ...
    public static void test()
    {
        ...
        AP.setKrokRozmer( 1, 150, 300 );
//        AP.setMrizka( true );

        Balon_12d b1 = new Balon_12d();
        Balon_12d b2 = new Balon_12d( 25, 0, 100, Barva.ZELENA );
        Balon_12d b3 = new Balon_12d( 100, 0,  50, Barva.MODRA );
//         P.cekej( 1000 );
