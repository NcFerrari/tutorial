/*******************************************************************************
 * Trida Vytah_6 simuluje vytah vozici pasazery
 *
 * @author    Rudolf Pecinovsky
 * @version   0.00.000,  0.0.2003
 */
public class Vytah_6 implements IKresleny, IPosuvny
{
...
//== KONSTANTNI ATRIBUTY INSTANCI ==============================================
    ...
    /** Vytah_6 pouzije pro vsechny posuny jednoho soukromeho presouvace. */
...
//== KONSTRUKTORY A TOVARNI METODY =============================================
     ...
     */
    public Vytah_6(int sloupec, int rychlost, Barva barva)
    {
...
//== PREKRYTE KONKRETNI METODY RODICOVSKE TRIDY ================================
    ...
    {
        return "Vytah_6_" + poradi + ": sloupec=" + sloupec + ", patro=" + patro;
    }
...
//== NOVE ZAVEDENE METODY INSTANCI =============================================
    ...
    public void nastup( IPosuvny pasazer )
    {
        ...
        AP.pridejPod( (IKresleny)this, (IKresleny)pasazer );
...
//== SOUKROME A POMOCNE METODY TRIDY ===========================================
    ...
    private void vystup( int posun )
    {
	    ...
	    AP.pridejPod( (IKresleny)this, (IKresleny) this.pasazer );
