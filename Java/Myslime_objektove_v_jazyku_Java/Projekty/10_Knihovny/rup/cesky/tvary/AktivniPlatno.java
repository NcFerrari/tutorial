...
{
//     static {
//         System.out.println( "Inicializace tridy AktivniPlatno" );
//     }
//== KONSTANTNI ATRIBUTY TRIDY =================================================

    /** Titulek okna aktivniho platna. */
    private static final String TITULEK_0  = "Aktivni platno";
    ...
    /** Jedina instance tridy AktivniPlatno. Protoze se po celou dobu zivota
     *  platna nemeni, je deklarovana jako verejna. */
    public static final AktivniPlatno AP = new AktivniPlatno();

    //Pri kresleni car se pta APosuvny po aktivnim platnu.
    //Proto se mohou cary kreslit az pote, co bude konstanta AP inicializovana.
    static
    {
